...
public class MarvellousUnpackFront extends Template implements ActionListener {
    ...
    public MarvellousUnpackFront() {
        ...
        label1 = new JLabel("Packed File Name:");
        ...
        text1.setToolTipText("Enter packed file name (e.g., packed.txt)");
    ...
    public void actionPerformed(ActionEvent ae) {
        ...
        if (ae.getSource() == SUBMIT) {
            String inputFile = text1.getText().trim();

            if (inputFile.isEmpty()) {
                JOptionPane.showMessageDialog(this, "Please enter the packed file name.", "Warning", JOptionPane.WARNING_MESSAGE);
                return;
            }

            try {
                MarvellousUnpack obj = new MarvellousUnpack(inputFile);
                JOptionPane.showMessageDialog(this, "Unpacking completed successfully!", "Success", JOptionPane.INFORMATION_MESSAGE);
                this.dispose();
