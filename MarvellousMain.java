// 25/11/2021.........File Packer-Unpacker Project..........MarvellousMain.java
	...
	public void actionPerformed(ActionEvent ae) {
		...
		if (ae.getSource() == SUBMIT) {
			if (Validate(value1, value2) == false) {
				text1.setText("");
				text2.setText("");
				JOptionPane.showMessageDialog(this, "Short username or password", "Marvellous Packer Unpacker", JOptionPane.ERROR_MESSAGE);
				return;
			}
			...
			if (value1.equals("MarvellousAdmin") && value2.equals("MarvellousAdmin")) {
				...
				if (attemp == 0) {
					...
					JOptionPane.showMessageDialog(this, "Incorrect login or password. Attempts left: " + attemp, "Error", JOptionPane.ERROR_MESSAGE);
				}
			}
		}
	}
